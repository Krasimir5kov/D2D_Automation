# DOM & Accessibility — Sales Actions: Neubau Side Panel

## Source
- `sales-actions/neubau-detail-door-level/side-panel-open/accessibility-report.json`
- `sales-actions/neubau-detail-door-level/side-panel-open/sanitized-dom.html`
- `sales-actions/neubau-detail-door-level/side-panel-open/IMPROVEMENTS.md`

## Accessibility Tree

### Violations

- **aria-command-name** — serious, 82 node(s): Ensure every ARIA button, link and menuitem has an accessible name
...
- **color-contrast** — serious, 114 node(s): Ensure the contrast between foreground and background colors meets WCAG 2 AA minimum contrast ratio thresholds
...
- **link-name** — serious, 2 node(s): Ensure links have discernible text
...
# UI Improvements - sales-actions / neubau-detail-door-level / side-panel-open

- Capture type: configured route sweep
- Total interactive elements: 436
...
- link: Diagnostic DOM path is long and would be brittle as a locator. Count: 36; priority: Medium
